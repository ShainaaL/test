<head>
    ...
    <div class="left">
        <div class="img-container">
            <img src="photos/sos.jpg" alt="sosalbum">
    ...
    <div class="player">
        <div id="conceited">
        <audio src="musiques/conceited.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>CONCEITED</h2>
    ...
    <div class="player">
        <div id="ihateyou">
        <audio src="musiques/ihateyou.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>I HATE YOU</h2>
